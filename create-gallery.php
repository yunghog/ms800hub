      ...
      <div class="row">
        <div class="col-12">
          <div class="blog-form-con">
            <form class="reg-form" enctype="multipart/form-data" action="assets/php/post-gal.php" method="post">
              <span class="form-label">Caption</span><br>
              <input type="text" name="cap" value="" placeholder="image caption"><br>
              <span class="form-label">Image</span><br>
              <input class="btn-site" type="file" name="gimg" value=""><br><br>
              ...
              <table id="myTable" class="table table-striped table-bordered table-dark" >
                <thead>
                  <tr>
                    ...
                    <th class="table_fonts">Caption</th>
                ...
                <tbody>
                  <?php
                  $i=1;
                  $query = "SELECT a.*,b.name FROM gallery a,users b where a.active=1 and b.id=a.user_id";
                  ...
                  while($row = mysqli_fetch_array($exe))
                  {
                    ...
                    <tr>
                      ...
                      <td>
                        <form class="" method="post" action="assets/php/delete-gal.php">
                        <input type="hidden" name="gal_id" value="<?php echo $row['id']; ?>">
