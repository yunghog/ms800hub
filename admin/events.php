      ...
      <head>
        ...
        <div class="content" id="fade">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1 class="big-text">Blog Panel</h1>
              ...
              <div class="col-md-12 table-column text-primary">
                <table class="table table-dark" id="gallery-table">
                  ...
                  <tbody>
                    <?php
                    if($_SESSION['role']==2){
                      $gal_query="SELECT a.*, b.username from blog a, users b where b.id='$user_id' and a.author_id='$user_id' and a.active=1";
                    }
                    if($_SESSION['role']==1){
                      $gal_query="SELECT a.*, b.username from blog a, users b where a.active=1 and a.author_id=b.id order by a.author_id";
                    }
                    $i=1;
            ...
            <div class="row">
              <div class="col-md-12">
                <h3 class="tag">Post Blog</h3>
              </div>
            </div>
              <br>
              <div class="row">
                <div class="col-md-12">
                  <form class="form-control2" action="../assets/php/blog_post.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-12">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <input type="text" name="title" value="" placeholder="Title of blog">
                      </div>
                    </div>
                    <br>
                    <div class="row">
                      <div class="col-12">
                        <textarea name="body" rows="3"  placeholder="body of blog"></textarea>
                      </div>
                    </div>
                    <br>
                    <div class="row">
        ...
        <script type="text/javascript">
          document.getElementById('blog').classList.add('text-primary');
