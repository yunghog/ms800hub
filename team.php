          ...
          <div class="container">
            <div class="row" >
              <div class="col-md-12 text-center">
                ...
                <h2 class="tag">Founders of the Club</h2>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card bg-black">
                  <img src="assets/img/admin1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                ...
                <div class="col-md-4">
                <div class="card bg-black">
                  <img src="assets/img/admin2.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="card bg-black">
                  <img src="assets/img/sponser1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Aditya Automobiles</h5>
                    <p class="card-text"><small class="text-muted text-primary">Maruti Suzuki Arena</small></p>
